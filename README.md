...
## エンジニアとしての理念
「誰もが、アイデアと挑戦で人生を好転できる世界」の実現を目指しています。昨年2020年、教育に関する事業や、ノーコードツールを用いた事業を行い、そこでアイデアを形にできる素晴らしさを知りました。一方で、自分ではどうすることもできない生まれながらにしたハンデを抱えている人たちがいることも知りました。誰もが、自分のアイデアを形にして、人生を自らの手で切り拓くことができたなら。そんな思いを持つようになりました。ITは、その最も適したツールとなりうると考えています。誰もが開発者として活動できる基盤の構築のために、エンジニアとして活動しています。

## これまで行ったプロジェクト
私がエンジニアとして行ってきたプロジェクトを以下に記述します。
<br>
- [①ウェブアプリ「スエマス新潟」開発](#プロジェクト①「スエマス新潟」)
- [②社内音声チャットツール開発](#プロジェクト①「スエマス新潟」)
- [③APIによるMVP開発](#プロジェクト①「スエマス新潟」)
